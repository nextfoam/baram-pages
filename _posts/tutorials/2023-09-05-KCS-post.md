---
layout: post
title: 11. KCS - Drag prediction of a ship with VOF model
category: tutorials
---
...
프로그램 실행 후 launcher에서 'New Case'를 선택하고 이름을 지정한다. 'Solver Type'은 Pressure-based, 'Multiphase Model'은 Volume of Fluid', Gravity는 (0 0 -9.81), 'Species'는 Not Include를 선택한다.
