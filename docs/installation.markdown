...
[Download BARAM v24.2.1 Installer for 64-bit Windows ›](https://d3c6e16xufx1gb.cloudfront.net/BARAM-24.2.1-setup.exe){: .btn .btn-purple .text-center .fs-5 onclick="trackDownload('BARAM-24.2.1-setup.exe')"}
